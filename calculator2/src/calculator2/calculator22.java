 ...
 * @author Jeewantha
 */
public class calculator22 extends javax.swing.JFrame {

    /**
     * Creates new form calculator22
     */
    double num,ans;
    int calculation;
    
    public void arithmetic_oparetion(){
        switch (calculation){
            case 1: 
    ...
    private void jButton16ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton16ActionPerformed
        arithmetic_oparetion();// TODO add your handling code here:
        jLabel1.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(calculator22.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new calculator22().setVisible(true);
            }
        });
    }
